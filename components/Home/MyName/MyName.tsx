  ...
  return (
    ...
    >
      ...
      >
        ...
        <span className="text-AAsecondary">mobile development domain</span>,
        where I actively engage in developing{" "}
        <br className="2xl:block hidden" />
        and designing immersive{" "}
        <span className="text-AAsecondary">Cross-platform applications</span>.
        This involves working with{" "}
        <span className="text-AAsecondary">React Native Framework.</span>
