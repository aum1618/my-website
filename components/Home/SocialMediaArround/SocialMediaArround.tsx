        ...
        <div className="flex flex-col space-y-8 justify-center items-center">
          <div className="flex flex-col justify-center items-center space-y-5">
            ...
            <IconClickableWithAnimation
              Icon={GithubIcon}
              href={"https://github.com/aum1618"}
            />
            {/* Linkedin icon */}
            <IconClickableWithAnimation
              Icon={LinkedinIcon}
              href={"https://www.linkedin.com/in/mraum/"}
            />
            {/* Instagram Icon */}
            <IconClickableWithAnimation
              Icon={InstagramIcon}
              href={"https://www.instagram.com/u_m3r/"}
            />
            {/* Youtube Icon */}
            <IconClickableWithAnimation
              Icon={YoutubeIcon}
              href={"https://www.facebook.com/muhammadumer.abbas.9/"}
            />
          </div>
